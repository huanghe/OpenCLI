...
cli({
    ...
    columns: ['id', 'author', 'author_avatar', 'bio', 'text', 'likes', 'retweets', 'replies', 'views', 'created_at', 'url', 'card', 'quoted_tweet', 'has_media', 'media_urls', 'media_posters', 'media_durations'],
